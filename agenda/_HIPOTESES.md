# Hipóteses e Experimentos — Backlog Vivo
...
| 🟡 | Em desenvolvimento — trabalho ativo |
| 🟢 | Positivo — confirmado, resultado registrado |
| 🔴 | Negativo — encerrado por protocolo, resultado registrado |
| ⚪ | Emergente — aguarda soma de outras hipóteses ou resultados |

---

## Hipóteses Herdadas do Primeiro Ciclo

### H01 — Teste sensorial eco hiperbólico
**Status:** 🔵 Pendente
**Origem:** Entrada 39 do Research Journal · maio 2026
**O que é:** O eco em espaço hiperbólico deslocou o atrator de 6.55Hz (delta) para 10.59Hz (alpha — vigília relaxada). O experimento computacional foi feito. O teste sensorial humano não foi.
**O que falta:** Comparar `beep880_euclid.wav` × `beep880_hiperbolico.wav` a 0,25× velocidade e registrar diferença na percepção ergonômica.
**Área:** Técnica + Estética

---

### H02 — Eco aplicado a áudio real / instrumento ao vivo
**Status:** 🔵 Pendente
**Origem:** Entrada 35 do Research Journal · maio 2026
**O que é:** O eco foi testado em harmônicos sintéticos e séries temporais φ. Nunca foi aplicado a sinal de áudio real capturado de instrumento (violão, voz, qualquer fonte orgânica ao vivo).
**O que falta:** Capturar sinal real via interface de áudio e aplicar eco como pré-função.
**Área:** Técnica

---

### H03 — Canal visual / pixel hiperbólico
**Status:** 🔵 Pendente
**Origem:** Entrada 35 do Research Journal
**O que é:** Hipótese nomeada — canal visual como segunda emissão quadrada; pixel hiperbólico como solução. O eco foi ao áudio. O visual nunca foi tocado.
**O que falta:** Formulação técnica do pixel hiperbólico + primeiro experimento.
**Área:** Técnica + Filosófica

---

### H04 — Osciloscópio / estrutura esférica do campo
**Status:** 🔵 Pendente
**Origem:** Entradas 52-53 do Research Journal · maio 2026
**O que é:** No gráfico verde, esferas se sobrepondo — no 7° segundo, uma esfera estabilizada (ergonomia). Resultado visual emergiu sem ser programado. Não foi investigado o que determina a estrutura: frequência fundamental, número de bandas, tipo de síntese?
**O que falta:** Variar os parâmetros sistematicamente e verificar se a estrutura esférica é robusta (estrutural) ou paramétrica.
**Área:** Técnica + Estética

---

### H05 — Gap de 1,36 / mínimo interior no espaço do sinal
**Status:** 🔵 Pendente
**Origem:** Entrada 28 do Research Journal · maio 2026
**O que é:** Gap irredutível de 1,36 identificado entre sinal digital e orgânico. Hipótese: misturar os próprios sinais (`x_mix(α) = (1-α)·digital + α·orgânico`) e rodar eco-φ no híbrido — encontrar o α onde emerge coerência própria máxima. Uma terceira estrutura que nenhum dos dois possui sozinho.
**O que falta:** Implementar e testar `AlphaPhi_Audio_Hibrido_Minimo.py`.
**Área:** Técnica

---

### H06 — L = CE + α·H(φ) — função de perda com α como threshold
**Status:** 🔵 Pendente
**Origem:** Entrada 4 do Research Journal · abril 2026 — identificado desde o início
**O que é:** Função de perda onde α (1/3 ou 1/137) age como threshold de granularidade mínima, não apenas como constante multiplicativa. Nunca foi testado.
**O que falta:** Implementar a função de perda e comparar com cross-entropy padrão em substrato controlado.
**Área:** Técnica

---

### H07 — MEG + eco — mapa de coerência neural em tempo real
**Status:** ⚪ Emergente
**Origem:** Entrada 22 do Research Journal
**O que é:** Aplicar eco como pré-função sobre sinal MEG bruto e computar k_campo de diferentes regiões cerebrais em tempo real. k→√2 = campo incoerente; k→φ = campo coerente. Nunca computado em MEG clínico.
**O que falta:** Parceria com laboratório que opere MEG. Não é experimento solo — requer colaboração externa.
**Área:** Técnica + Propositiva

---

### H08 — Escala φ de extensão espectral — sete sinais FM
**Status:** 🔵 Pendente
**Origem:** Entrada 26 do Research Journal · maio 2026
**O que é:** Próximo experimento natural identificado: sete sinais FM em progressão φ como substrato. Nunca executado.
**O que falta:** Gerar os sete sinais e rodar eco-φ como pré-função.
**Área:** Técnica

---

### H09 — Eco aplicado ao BERT / SST-2 hiperbólico
**Status:** 🔵 Pendente
**Origem:** Experimentos anteriores — BERT neutro (p=0,94) em 3 experimentos sem eco
**O que é:** O BERT resistiu a qualquer modificação sem eco. A pergunta não respondida: e se o eco for aplicado como pré-função antes do BERT processar? O substrato consolidado pode ter resultado diferente com eco.
**O que falta:** `AlphaPhi_BERT_Eco_PreFuncao.py`
**Área:** Técnica

---

### H10 — Eco fractal
**Status:** 🔴 Negativo — encerrado
**Origem:** Entrada 13 do Research Journal · abril 2026
**O que foi:** Três experimentos, três resultados negativos consistentes. O campo fonônico produziu incrementos suaves de coerência, não saltos discretos. Limiar 1/φ²=0,382 inacessível. Nascimentos: 0/20 seeds em todos.
**Conclusão:** Resultado negativo integral registrado por protocolo. A hipótese de oitavas fractais por Δcoerência não é suportada neste substrato.
**Área:** Técnica
...
**Formato confirmado:** PDF compilado de 228 páginas — todos os componentes da obra (texto, código, áudio, imagens) compilados em formato único. Formato padrão aceito pela BN. Risco de não adequação técnica eliminado. Nenhuma verificação adicional de formato necessária.
