...
O que faz
Status
AlphaPhi_Original_RobustezEstrutura.ipynb
Código original corrigido — 20 seeds aleatórios — mede estabilidade e entropia estrutural
✅ Resultado limpo: +35% estabilidade, p=0,0017
AlphaPhi_TesteIndependente_v3.ipynb
Teste de aprendizado — regressão sintética — 20 seeds aleatórios — Xavier/Kaiming
🔄 Resultado neutro — requer GPU + SST-2 real
AlphaPhi_FLOPs_Viabilidade.ipynb
Estudo de viabilidade energética — FLOPs, tempo de execução, extrapolação data center
🔭 Estimativa de horizonte — confirmar em hardware real
